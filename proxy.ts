...
export async function proxy(request:NextRequest){
  ...
  const viewerPersonalMutation=pathname.startsWith('/api/account/')||pathname==='/api/auth/signout'||pathname==='/api/approvals/notifications/read'||pathname.startsWith('/api/support/')||pathname==='/api/store-requests'||pathname.startsWith('/api/store-deliveries/')||pathname.startsWith('/api/store-transactions')||pathname.startsWith('/api/store-receipts/')||pathname==='/api/store-locations'||pathname==='/api/store-counts';
