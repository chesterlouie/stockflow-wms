...
export default function ModuleThree(){return <section className="panel" id="module-3">
  ...
  <h3>Current warehouse-scope boundary</h3>
  <div className="knowledge-note"><strong>QA notice:</strong> warehouse assignments are saved and displayed in the login profile. Requesting-store isolation is enforced in the Store Portal. Complete warehouse-by-warehouse filtering across every operational screen, transaction API, and report remains a required security-hardening step before production.</div>
