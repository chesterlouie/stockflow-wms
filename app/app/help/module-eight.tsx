...
export default function ModuleEight(){return <section className="panel" id="module-8">
  ...
  <p>Owners, administrators, or managers normally review demand and release work. Operators execute permitted picking, packing, sealing, and dispatch scans. Assign every internal user to the appropriate warehouse from Users &amp; access; complete end-to-end warehouse-scope enforcement must pass production-readiness security QA before live customer use.</p>
