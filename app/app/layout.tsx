...
const links=[['/app/dashboard','⌂','Dashboard'],['/app/items','□','Item master'],['/app/purchasing','▤','Purchasing'],['/app/purchasing/import','↥','PO import'],['/app/receiving','⇩','Receiving'],['/app/receiving/mobile','▣','Mobile receiving'],['/app/putaway/mobile','↳','Mobile putaway'],['/app/replenishment','↻','Replenishment'],['/app/orders','⇧','Orders & picking'],['/app/waves','≋','Pick waves'],['/app/returns','↩','Returns'],['/app/inventory','⇄','Inventory'],['/app/counts','✓','Counts'],['/app/reports','▥','Reports'],['/app/integrations','⌁','ERP integrations'],['/app/users','♙','Users & access'],['/app/setup','⌘','Warehouse setup'],['/app/company','⚙','Company & plan'],['/app/billing','₱','Subscription & billing'],['/account/security','⚿','Account security']];
