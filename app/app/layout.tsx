...
const links=[['/app/dashboard','⌂','Dashboard'],['/app/items','□','Item master'],['/app/purchasing','▤','Purchasing'],['/app/receiving','⇩','Receiving'],['/app/orders','⇧','Orders & picking'],['/app/inventory','⇄','Inventory'],['/app/counts','✓','Counts'],['/app/reports','▥','Reports'],['/app/integrations','⌁','ERP integrations'],['/app/users','♙','Users & access'],['/app/setup','⌘','Warehouse setup'],['/app/company','⚙','Company & plan'],['/app/billing','₱','Subscription & billing'],['/account/security','⚿','Account security']];
