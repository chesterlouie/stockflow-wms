  ...
  return <div className="app-content">
    ...
    <form className="form-layout" method="post" action="/api/items">
      <section className="panel form-section">
        ...
        <div className="form-row"><div className="field"><label htmlFor="category">Category</label><input id="category" name="category" placeholder="Choose or create category" /></div><div className="field"><label htmlFor="uom">Base unit</label><select id="uom" name="uom"><option value="EA">EA — Each</option><option value="CASE">CASE — Case</option><option value="KG">KG — Kilogram</option><option value="BAG">BAG — Bag</option></select></div></div>
        <h2>Barcode ID</h2>
